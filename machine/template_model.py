    ...
    def predict(self, img:np.ndarray, confidence_threshold:float=0.5, show:bool=False) -> dict:
        ...
        Returns:
          dict: A dictionary conatining information about predicted objects in the input image. See example below.
            {
              "bot1": {"bbox":[[top_left_x:int, top_left_y:int],[bottom_right_x:int, bottom_right_y:int]], "center":[center_x:int, center_y:int], "img":np.ndarry},
              "bot2": {"bbox":[[top_left_x:int, top_left_y:int],[bottom_right_x:int, bottom_right_y:int]], "center":[center_x:int, center_y:int], "img":np.ndarry},
              "housebot": {"bbox":[[top_left_x:int, top_left_y:int],[bottom_right_x:int, bottom_right_y:int]], "center":[center_x:int, center_y:int], "img":np.ndarry}
            }
        """
        raise "Not implemented in subclass"
