...
class OurModel:
    ...
    # Preprocess image
        ...
        print(f"housebot scores = {housebot_scores}")
        ...
        print(f"final scorees = {final_scores}")
        return final_boxes, final_scores

    
    def draw_prediction(self, img, confidences, bboxes, confidence_threshold=0.1):
        height, width, _ = img.shape
        print("watch 1")

        print(f"confisence in loop = {confidences}")
...
if __name__ == '__main__':
    ...
    # Load image
    img = cv2.imread("data/NHRL/test/images/2242_png.rf.e3285eb24831c586a0bfa92f70110a6e.jpg")
    
    # Run prediction
    out = predictor.predict(img)
    bboxes,confidences = out
    print(f"out = {out}")
    ...
    pred_img = predictor.draw_prediction(img, confidences, bboxes, confidence_threshold=0.01)
